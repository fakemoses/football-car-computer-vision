...
public class GoalDetection2 extends DetectionThread{
    ...
    public GoalDetection2(MotorControl motorControl, ColorFilter colorFilter, ObjectDetector objectDetector) {
