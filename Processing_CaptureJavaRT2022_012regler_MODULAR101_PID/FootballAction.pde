...
// void detectOpponent() {
//  // checkif bounding box appears at different sections of screen (assumption to decide distance to robot)
//  // upperthird = opponent is far away
//  // middle third = opponent is near
//  // lowerthird = opponent is too near

//  Rectangle[] opponent = this.detectObject();
//  for (inti = 0; i < opponent.length; i++) {
//    if (opponent[i].y >= 2 * height / 3) {
//      println("Thedetected opponent is too close to player.");
//      //reverse car slowly
//    } elseif ((opponent[i].y < 2 * height / 3) && (opponent[i].y >= height / 3)) {
//      println("Thedetected opponent is near to the player.");
//      goalkeeperMode();
//    } elseif (opponent < height / 3) {
//      println("Thedetected opponent is far away from the player");
//      attackerMode();
//    }
//  }
// }
